		...
		var S = {
			...
			u = function(a, c, b) {
				...
				if("_resetY" !== c && "_resetX" !== c) {
					!g.contentReset.y && a[0].mcs || !g.overflowed[0] || (k("onOverflowY") && f.callbacks.onOverflowY.call(a[0]), g.contentReset.x = null);
					!g.contentReset.x && a[0].mcs || !g.overflowed[1] || (k("onOverflowX") && f.callbacks.onOverflowX.call(a[0]), g.contentReset.x = null);
					...
					ha(t[0], A, Math.round(x[1]), e[1], b.scrollEasing);
					!g.tweenRunning && (0 === v && 0 <= x[0] || v === w[0] && x[0] <= w[0]) || ha(h[0], A, Math.round(x[0]), e[0], b.scrollEasing, b.overwrite, {
						onStart: function() {
			...
			ha = function(a, c, b, d, l, g, f) {
				...
				var z = b - w;
				s.stop = 0;
				"none" !== g && null != s.id && (window.requestAnimationFrame ? window.cancelAnimationFrame(s.id) : clearTimeout(s.id), s.id = null);
				(function() {
					u = 1E3 / 60;
					s.time = v + u;
		...
		return this.each(function() {
			...
			if(!a.data("autosize")) {
				...
				if("onpropertychange" in b)
					if("oninput" in b) a.on("input.autosize keyup.autosize", f);
...
(function(b) {
	...
	b.imgAreaSelect = function(z, d) {
		...
		function ua(a) {
			b("body").css("cursor", "");
			(d.autoHide || 0 == c.width * c.height) && ma(l.add(m),
				function() {
					b(this).hide()
				});
		...
		z.complete || "complete" == z.readyState || !x.is("img") ? za() : x.one("load", za);
		!$ && S && 7 <= S && (z.src = z.src)
	};
...
jQuery.fn.highlight = function(f, n) {
	...
	for(var m = 0; m < g.length; m++) {
		...
		if(l.test(u)) g.splice(m, 1);
			...
			for(var s = g.length - 1; s > m; s--) u == g[s] && g.splice(s, 1)
	}
	var x = [{
				spChar: "\\",
				escapeChar: "\\\\"
...
(function(s, D, f, K) {
	...
	f.extend(b, {
		...
		_afterLoad: function() {
			...
			b.hideLoading();
			if(a && !1 !== b.isActive)
				if(!1 === b.trigger("afterLoad", a, d)) a.wrap.stop(!0).trigger("onReset").remove(),
					b.coming = null;
				else {
		...
		_setDimension: function() {
			...
			if(k.fitToView)
				if(g.width(c).height(h), e.width(c + x), a = e.width(), z = e.height(), k.aspectRatio)
					for(;
						(a > A || z > s) && c > n && h > u && !(19 < d++);) h = Math.max(u, Math.min(q, h - 10)),
						c = m(h * E),
						c < n && (c = n, h = m(c / E)),
						c > p && (c = p, h = m(c / E)),
						g.width(c).height(h),
	...
	b.helpers.overlay = {
		...
		onReady: function(a, b) {
			...
			e || this.create(a);
			a.locked && this.fixed && b.fixed && (e || (this.margin = q.height() > p.height() ? f("html").css("margin-right").replace("px", "") : !1), b.locked = this.overlay.append(b.wrap), b.fixed = !1);
	...
	var O = function(g) {
		...
		function Hb(a, b) {
			...
			for(var f, h = p.ext.type.order[c.sType + "-pre"], g = 0, j = a.aoData.length; g < j; g++)
				if(c = a.aoData[g], c._aSortData || (c._aSortData = []), !c._aSortData[b] || e) f = e ? d[g] : v(a, g, b, "sort"),
				...
				if(c.length && a.length) {
					...
					if(e._details) {
						...
						0 < C(h, "_details").length && (f.on("draw.dt.DT_details",
							...
							function(a, b) {
								if(d === b)
									for(var c, e = aa(b), f = 0, g = h.length; f < g; f++) c = h[f],
...
(function(Ca, O, ic) {
	(function(g) {
		...
		function U(a) {
			...
			g.each(a,
				function(e, f) {
					(b = e.match(/^([^A-Z]+?)([A-Z])/)) && -1 !== "a aa ai ao as b fn i m o s ".indexOf(b[1] + " ") && (c = e.replace(b[0], b[2].toLowerCase()), d[c] = e, "o" === b[1] && U(a[e]))
				});
			a._hungarianMap = d
		}
		...
		function Da(a) {
			var b = p.defaults.oLanguage,
				c = a.sZeroRecords;
			!a.sEmptyTable && c && "No data available in table" === b.sEmptyTable && G(a, a, "sZeroRecords", "sEmptyTable");
			!a.sLoadingRecords && c && "Loading..." === b.sLoadingRecords && G(a, a, "sZeroRecords", "sLoadingRecords");
			a.sInfoThousands && (a.sThousands = a.sInfoThousands);
			(a = a.sDecimal) && cb(a)
		}
		...
		function Ga(a) {
			...
			for(f = b.length; e < f; e++)
				if(m = b[e], q = [], !m.sType && m._sManualType) m.sType = m._sManualType;
				else if(!m.sType) {
				h = 0;
			...
			if(b)
				for(e = b.length - 1; 0 <= e; e--) {
					...
					for(h = r.length; f < h; f++)
						...
						for(k = 0, l = m.length; k < l; k++)("_all" == r[f] || g(m[k].nTh).hasClass(r[f])) && d(k, n)
				}
			if(c)
			...
			if("dom" !== c && (c && "auto" !== c || "dom" !== e.src)) {
				...
				if(k)
					if(void 0 !== d) h(k[d], d);
						...
						for(c = 0, f = k.length; c < f; c++) h(k[c], c)
		...
		function la(a, b, c, d) {
			...
			if(f)
				for(; f;) {
					...
					for(e = b.anCells, f = 0, b = e.length; f < b; f++) a(e[f]);
			return {
				data: d,
				cells: e
			}
		...
		function ib(a) {
			...
			if(null !== k)
				for(a = a.aoFooter[0], b = 0, c = a.length; b < c; b++) f = m[b],
					f.nTf = a[b].cell,
					f.sClass && g(f.nTf).addClass(f.sClass)
		}
		...
		function M(a) {
			...
			if(-1 !== g.inArray(!1, b)) E(a, !1);
				...
				if(0 !== l.length)
					for(f = k ? a.aoData.length : n, k = k ? 0 : h; k < f; k++) {
						var m = l[k],
							r = a.aoData[m];
						null === r.nTr && Ia(a, m);
						m = r.nTr;
		...
		function lb(a) {
			...
			for(var f = a.sDom.split(""), h, k, l, n, m, r, q = 0; q < f.length; q++) {
				...
				if("\x3c" == k) {
					...
					for(l = p.ext.feature, r = 0, n = l.length; r < n; r++)
						if(k == l[r].cFeature) {
							h = l[r].fnInit(a);
							break
						}
		...
		function xb(a) {
			...
			for(f = a.aoData.length; d < f; d++)
				if(n = a.aoData[d], !n._aFilterData) {
					k = [];
					e = 0;
		...
		function X(a) {
			...
			r.scroll();
			!a.bSorted && !a.bFiltered || a._drawHold || (l.scrollTop = 0)
		}
		...
		function Fa(a) {
			...
			if(r || f || e || k != $(a) || k != l.length) {
				...
				for(q = 0; q < d.length; q++)
					if(p = c[d[q]], e = g(l[q]).width()) p.sWidth = w(e);
				b.style.width = w(k.css("width"));
				k.remove()
			} else
				for(q = 0; q < k; q++) c[q].sWidth = w(l.eq(q).width());
			n && (b.style.width = w(n));
			!n && !f || a._reszEvt || (g(Ca).bind("resize.DT-" + a.sInstance, ta(function() {
				W(a)
			})), a._reszEvt = !0)
		}
		...
		function S(a) {
			...
			c && b.post && f(b.post);
			for(a = 0; a < n.length; a++)
				for(l = n[a][0], f = e[l].aDataSort, b = 0, c = f.length; b < c; b++) h = f[b],
					k = e[h].sType || "string",
			...
			if("ssp" != D(a) && 0 !== n.length) {
				...
				h === n.length ? l.sort(function(a, b) {
					var c, e, h, g, k = n.length,
						...
						p = f[b]._aSortData;
					for(h = 0; h < k; h++)
						if(g = n[h], c = l[g.col], e = p[g.col], c = c < e ? -1 : c > e ? 1 : 0, 0 !== c) return "asc" === g.dir ? c : -c;
					c = d[a];
					e = d[b];
					...
					var c, h, g, k, l = n.length,
						...
						t = f[b]._aSortData;
					for(g = 0; g < l; g++)
						if(k = n[g], c = p[k.col], h = t[k.col], k = e[k.type + "-" + k.dir] || e["string-" + k.dir], c = k(c, h), 0 !== c) return c;
					c = d[a];
					h = d[b];
					return c < h ? -1 : c > h ? 1 : 0
				})
		...
		function Na(a, b, c, d) {
			...
			Ua(b, {},
				function(b) {
					!1 !== e.bSortable && (a.oFeatures.bProcessing ? (E(a, !0), setTimeout(function() {
							Ta(a, c, b.shiftKey, d);
							"ssp" !== D(a) && E(a, !1)
						},
		...
		function Hb(a, b) {
			...
			for(var f, h = p.ext.type.order[c.sType + "-pre"], g = 0, l = a.aoData.length; g < l; g++)
		...
		p = function(a) {
			...
			this.fnSetColumnVis = function(a, b, c) {
				a = this.api(!0).column(a).visible(b);
				(void 0 === c || c) && a.columns.adjust().draw()
			};
			this.fnSettings = function() {
			...
			this.fnUpdate = function(a, b, c, d, e) {
				var g = this.api(!0);
				void 0 === c || null === c ? g.row(b).data(a) : g.cell(b, c).data(a);
				(void 0 === e || e) && g.columns.adjust();
				(void 0 === d || d) && g.draw();
				return 0
			};
			...
			this.each(function() {
				...
				if("table" != this.nodeName.toLowerCase()) Q(null, 0, "Non-table node initialisation (" + this.nodeName + ")", 2);
					...
					G(s, e, ["asStripeClasses", "ajax", "fnServerData", "fnFormatNumber", "sServerMethod", "aaSorting", "aaSortingFixed", "aLengthMenu", "sPaginationType", "sAjaxSource", "sAjaxDataProp", "iStateDuration", "sDom", "bSortCellsTop", "iTabIndex", "fnStateLoadCallback", "fnStateSaveCallback", "renderer", "searchDelay", ["iCookieDuration", "iStateDuration"],
						["oSearch", "oPreviousSearch"],
						["aoSearchCols", "aoPreSearchCols"],
						["iDisplayLength", "_iDisplayLength"],
						["bJQueryUI", "bJUI"]
					...
					r.addClass(l.sTable);
					if("" !== s.oScroll.sX || "" !== s.oScroll.sY) s.oScroll.iBarWidth = Gb();
					!0 === s.oScroll.sX && (s.oScroll.sX = "100%");
					...
					if(null === e.aoColumns)
						for(t = [], h = 0, k = q.length; h < k; h++) t.push(null);
					else t = e.aoColumns;
					h = 0;
					...
					if(void 0 === e.aaSorting)
						for(q = s.aaSorting, h = 0, k = q.length; h < k; h++) q[h][1] = s.aoColumns[h].asSorting[0];
					wa(s);
					...
					z(s, "aoDrawCallback",
						function() {
							(s.bSorted || "ssp" === D(s) || y.bDeferRender) && wa(s)
						},
						"sc");
					fb(s);
					...
					if(e.aaData)
						for(h = 0; h < e.aaData.length; h++) K(s, e.aaData[h]);
			...
			iterator: function(a, b, c, d) {
				...
				for(g = m.length; h < g; h++) {
					...
					if("table" === b) f = c.call(s, m[h], h),
						...
						for(q = this[h], "column-rows" === b && (r = Ba(m[h], p.opts)), l = 0, n = q.length; l < n; l++) f = q[l],
		...
		u.register = t = function(a, b) {
			if(g.isArray(a))
				...
				for(var e = a.split("."), f = Sb, h, k, c = 0, d = e.length; c < d; c++) {
		...
		var Za = function(a, b) {
				...
				f = 0;
				for(h = a.length; f < h; f++)
					for(e = a[f] && a[f].split ? a[f].split(",") : [a[f]], k = 0, l = e.length; k < l; k++)(d = b("string" === typeof e[k] ? g.trim(e[k]) : e[k])) && d.length && c.push.apply(c, d);
				return c
			},
			$a = function(a) {
				a || (a = {});
			...
			Ba = function(a, b) {
				...
				if("current" == e)
					for(c = a._iDisplayStart, d = a.fnDisplayEnd(); c < d; c++) f.push(h[c]);
				else if("current" == d || "applied" == d) f = "none" == k ? c.slice() : "applied" == k ? h.slice() : g.map(c,
					function(a, b) {
						return -1 === g.inArray(a, h) ? a : null
					});
				else if("index" == d || "original" == d)
					for(c = 0, d = a.aoData.length; c < d; c++) "none" == k ? f.push(c) : (e = g.inArray(c, h), (-1 === e && "removed" == k || 0 <= e && "applied" == k) && f.push(c));
				return f
			},
			cc = function(a, b, c) {
				return Za(b,
		...
		var dc = function(a, b, c, d) {
			...
			ec = function(a) {
				...
				0 < F(c, "_details").length && (b.on("draw.dt.DT_details",
					...
					function(b, e, f, h) {
						if(a === e)
							for(e = $(e), f = 0, h = c.length; f < h; f++) b = c[f],
		...
		t("row().child()",
			function(a, b) {
				var c = this.context;
				if(void 0 === a) return c.length && this.length ? c[0].aoData[this[0]]._details : void 0;
				!0 === a ? this.child.show() : !1 === a ? bb(this) : c.length && this.length && dc(c[0], c[0].aoData[this[0]], a, b);
				return this
			});
				...
				var d = this.columns(b, c),
					...
					m = this.iterator("table",
						function(a, b) {
							f = [];
							h = 0;
							for(k = e[b].length; h < k; h++)
								for(l = 0, n = d[b].length; l < n; l++) f.push({
									row: e[b][h],
									column: d[b][l]
								});
							return f
			...
			function(a) {
				...
				return this.iterator("table",
					function(b) {
						...
						(r = b.asDestroyStripes.length) && f.children().each(function(a) {
				...
				_: function(a, b, c, d, e, f) {
					var h = a.oClasses,
						...
						p = function(b, d) {
							...
							q = 0;
							for(t = d.length; q < t; q++)
								if(v = d[q], g.isArray(v)) u = g("\x3c" + (v.DT_el || "div") + "/\x3e").appendTo(b),
									p(u, v);
								else {
									n = l = "";
									switch(v) {
...
(function(b) {
	...
	function u(a, b) {
		...
		if(a && a.getAttribute("data-placeholder-value")) b(a);
			...
			for(c = a ? a.getElementsByTagName("input") : h, d = a ? a.getElementsByTagName("textarea") : n, f = 0, g = c.length + d.length; f < g; f++) e = f < c.length ? c[f] : d[f - c.length],
				b(e)
	}
	...
	function F(a) {
		return function(b) {
			t = a.value;
			if("true" === a.getAttribute("data-placeholder-active") && t === a.getAttribute("data-placeholder-value") && g.inArray(G, b.keyCode)) return b.preventDefault && b.preventDefault(), !1
		}
	}
...
function(e) {
	...
	var u = function(a, b) {
		...
		if(this.wheelViewModeNavigation)
			if(e.fn.mousewheel) this.picker.on({
	...
	u.prototype = {
		...
		_attachEvents: function() {
			...
			}])) : this.element.is("div") || this.element.hasClass("inline") ? this.isInline = !0 : this._events = [
				[this.element, {
					click: e.proxy(this.show, this)
				}]
			];
		...
		fill: function() {
			if(null != this.date && null != this.viewDate) {
				...
				for(k = 0; 24 > k; k++) h = r(b, c, d, k),
					p = "",
					q = " halfhour",
					h.valueOf() + 36E5 <= this.startDate || h.valueOf() > this.endDate ? (p += " disabled", q += " disabled") : n == k && (p += " active"), !k % 3 && m.push('\x3cfieldset class\x3d"hour"\x3e\x3clegend\x3e' + t.toUpperCase() + "\x3c/legend\x3e"),
					h = k,
					...
					m.push('\x3cspan class\x3d"hour' + q + " hour_" + (12 > k ? "am" : "pm") + '" hour\x3d"' + h + '" minute\x3d"30"\x3e' + h + ":30\x3c/span\x3e"), !(k + 1) % 3 && m.push("\x3c/fieldset\x3e");
		...
		click: function(a) {
			...
			if(1 == b.length)
				if(b.is(".disabled")) this.element.trigger({
					type: "outOfRange",
					date: this.viewDate,
					startDate: this.startDate,
					endDate: this.endDate
			...
			parseDate: function(a, b, c, d) {
				...
				if(g.length == b.parts.length) {
					...
					for(l = 0; l < w.length; l++)
						if(d = w[l], d in v && !isNaN(v[d])) s[d](a, v[d])
				}
				return a
			},
	...
	d.extend({
		...
		pnotify: function(e) {
			...
			b.pnotify = function(n) {
				...
				if(a.icon !== c.icon || !0 === a.icon && a.type != c.type) b.container.find("div.ui-pnotify-icon").remove(), !1 !== a.icon && d("\x3cdiv /\x3e", {
					...
					f.on("click", ".modal-footer a",
						function(b) {
							...
							if("undefined" === typeof c || "undefined" === typeof a[c].href) b.preventDefault(),
								"function" === typeof d && (e = d(b)), !1 !== e && f.modal("hide")
						});
					r("body").append(f);
					f.modal({
	...
	function(p) {
		...
		function x(a) {
			...
			if(this._options.steps)
				for(var e = [], g = 0, e = this._options.steps.length; g < e; g++) {
		...
		function r(a) {
			...
			if((a = document.querySelectorAll(".introjs-fixParent")) && 0 < a.length)
				for(var c = a.length - 1; 0 <= c; c--) a[c].className = a[c].className.replace(/introjs-fixParent/g, "").replace(/^\s+|\s+$/g, "");
		...
		function u(a) {
			...
			if(null != c) {
				...
				if((c = document.querySelectorAll(".introjs-fixParent")) && 0 < c.length)
					for(var k = c.length - 1; 0 <= k; k--) c[k].className = c[k].className.replace(/introjs-fixParent/g, "").replace(/^\s+|\s+$/g, "");
...
(function(r) {
	...
	(function(a) {
		...
		for(e = 0; e < a.length; e += 2)
			for(c = a[e + 1].split(/ /), f = 0; f < c.length; f++) v[c[f]] = a[e]
			...
			if(a[l] && s[a[l]] && s[a[l]][e]) {
				...
				for(var d = f.length - 1; 0 <= d; d--)
					if(f[d].key === b || f[d].orig === c)
						if(a.removeEventListener ? a.removeEventListener(e, f[d].func, !1) : a.detachEvent && a.detachEvent("on" + e, f[d].func), f[d].orig = null, f[d].func = null, f.splice(d, 1), void 0 !== c) break;
			...
			h.extend(this, {
				...
				init: function() {
					function b() {
						...
						if(a) {
							...
							if(e = c.settings.required_features)
								for(e = e.split(","), f = 0; f < e.length; f++)
									if(!d[e[f]]) {
										b();
										return
									}
					...
					c.bind("FilesAdded",
						function(b, e) {
							var f, g, y = 0,
								q;
							(f = a.filters) && f.length && (q = [], h.each(f,
								function(b) {
									h.each(b.extensions.split(/,/),
										function(b) {
											/ ^\s * \ * \s * $ /.test(b) ? q.push("\\.*") : q.push("\\." + b.replace(new RegExp("[" + "/^$.*+?|()[]{}\\".replace(/./g, "\\$\x26") + "]", "g"), "\\$\x26"))
										})
					...
					c.bind("StateChanged",
						function(b) {
							if(b.state == h.STARTED) q = +new Date;
								...
								for(g = b.files.length - 1; 0 <= g; g--) b.files[g].status == h.UPLOADING && (b.files[g].status = h.QUEUED, f())
						});
					...
					if(a.runtimes)
						for(u = [], l = a.runtimes.split(/\s?,\s?/), g = 0; g < l.length; g++) D[l[g]] && u.push(D[l[g]]);
					else u = D;
					b();
				...
				getFile: function(b) {
					...
					for(a = d.length - 1; 0 <= a; a--)
						if(d[a].id === b) return d[a]
				},
				removeFile: function(b) {
					var a;
					for(a = d.length - 1; 0 <= a; a--)
						if(d[a].id === b.id) return this.splice(a, 1)[0]
				},
				splice: function(b, a) {
					var c;
				...
				trigger: function(b) {
					var a = c[b.toLowerCase()],
						...
						e;
					if(a)
						for(e = Array.prototype.slice.call(arguments), e[0] = this, d = 0; d < a.length; d++)
							if(!1 === a[d].func.apply(a[d].scope, e)) return !1;
					return !0
				},
			...
			10 > D() ? r({
				...
				function() {
					...
					function(a) {
						...
						delete v[a.id];
						delete E[a.id];
						(a = n.getElementById(a.id + "_flash_container")) && a.parentNode.removeChild(a)
					}), k.bind("Flash:Init",
					function() {
						var a = {};
						try {
	...
	function H(g) {
		...
		if(65496 === f.SHORT(0)) {
			...
			for(g = Math.min(1048576, g.length); c <= g;)
				if(b = f.SHORT(c), 65488 <= b && 65495 >= b) c += 2;
				else {
	...
	function B() {
		function h(b, d) {
			var e = a.SHORT(b),
				...
				n = {};
			for(g = 0; g < e; g++)
				if(m = b + 12 * g + 2, k = d[a.SHORT(m)], k !== t) {
					h = a.SHORT(m += 2);
					p = a.LONG(m += 2);
					m += 4;
					l = [];
		...
		init: function(h, a) {
			...
			f.html5 ? (h.bind("Init",
				function(a) {
					...
					k = 0;
					a: for(; k < p.length; k++)
						for(m = p[k].extensions.split(/,/), l = 0; l < m.length; l++) {
							if("*" === m[l]) {
								f = [];
								break a
								...
								c.onreadystatechange = function() {
									...
									if(4 == c.readyState && a.state !== g.STOPPED) {
										...
										if(400 <= f) a.trigger("Error", {
											...
											a.trigger("UploadProgress", d);
											e = t = y = v = null;
											!A || ++n >= A ? (d.status = g.DONE, a.trigger("FileUploaded", d, {
												response: c.responseText,
												status: f
											})) : $.ajax({
												type: "get",
	...
	var q = m.document,
		...
		s = function() {
			...
			for(b = f.length; a < b; a++)
				if(null != (c = f[a]))
					for(d in c) r.call(c, d) && (e = c[d], g !== e && void 0 !== e && (g[d] = e));
			return g
		},
		z = function(a) {
			var b, c, d;
			if("object" !== typeof a || null == a) b = a;
				...
				for(b = [], c = 0, d = a.length; c < d; c++) r.call(a, c) && (b[c] = z(a[c]));
			else
				for(c in b = {},
		...
		da = function(a) {
			if("object" === typeof a && null !== a)
				for(var b in a)
					if(r.call(a, b))
						if(/^(?:forceHandCursor|title|zIndex|bubbleEvents)$/.test(b)) h[b] = a[b];
		...
		ga = function(a, b) {
			...
			if("string" === typeof a && a) e = a.toLowerCase().split(/\s+/);
				...
				for(c in a)
					if(r.call(a, c) && "string" === typeof c && c && "function" === typeof a[c]) g.on(c, a[c]);
			if(e && e.length) {
				c = 0;
		...
		ha = function(a, b) {
			...
			if(0 === arguments.length) f = P(y);
				...
				for(c in a) r.call(a, c) && "string" === typeof c && c && "function" === typeof a[c] && g.off(c, a[c]);
			if(f && f.length)
				for(c = 0, d = f.length; c < d; c++)
					if(a = f[c].toLowerCase().replace(/^on/, ""), (n = y[a]) && n.length)
						if(b)
							for(e = v(b, n); - 1 !== e;) n.splice(e, 1),
								e = v(b, n, e);
						else n.length = 0;
			return g
		},
		...
		ja = function(a) {
			...
			if(a = S(a)) {
				...
				switch(b.type) {
					...
					case "_mouseover":
						g.focus(e);
						!0 === h.bubbleEvents && f && (e && e !== b.relatedTarget && !R(b.relatedTarget, e) && A(s({},
							b, {
								type: "mouseenter",
								bubbles: !1,
								cancelable: !1
				...
				if(!b) {
					...
					if("copy" === a.type) {
						...
						if("object" === typeof p && p) {
							for(d in p)
								if(d && r.call(p, d) && "string" === typeof p[d] && p[d]) switch(d.toLowerCase()) {
									case "text/plain":
									case "text":
									case "air:text":
									case "flash:text":
		...
		pa = function(a) {
			if("undefined" === typeof a) {
				if(p)
					for(var b in p) r.call(p, b) && delete p[b];
				H = null
		...
		ua = function() {
			var a = function(a, c) {
				var d, e, f;
				if(null != a && "*" !== c[0] && ("string" === typeof a && (a = [a]), "object" === typeof a && "number" === typeof a.length))
	...
	var xa = function(a) {
		...
		ya = function(a, b) {
			...
			if("string" === typeof a && a) e = a.toLowerCase().split(/\s+/);
				...
				for(c in a)
					if(r.call(a, c) && "string" === typeof c && c && "function" === typeof a[c]) this.on(c, a[c]);
			if(e && e.length) {
				c = 0;
				for(d = e.length; c < d; c++) a = e[c].replace(/^on/, ""),
					f[a] = !0,
		...
		za = function(a, b) {
			...
			if(0 === arguments.length) f = P(h);
				...
				for(c in a) r.call(a, c) && "string" === typeof c && c && "function" === typeof a[c] && this.off(c, a[c]);
			if(f && f.length)
				for(c = 0, d = f.length; c < d; c++)
					if(a = f[c].toLowerCase().replace(/^on/, ""), (g = h[a]) && g.length)
						if(b)
							for(e = v(b, g); - 1 !== e;) g.splice(e, 1),
								e = v(b, g, e);
						else g.length = 0;
			return this
		},
		...
		Ba = function(a) {
			...
			if(b && ("object" === typeof a && a && "string" === typeof a.type && a.type && (a = s({},
					...
					S(a), {
						client: this
					}), "object" === typeof a && a && a.type && (b = U(a), (c = (t[this.id] && t[this.id].handlers["*"] || []).concat(t[this.id] && t[this.id].handlers[a.type] || [])) && c.length)))
				for(var f, g, h, d = 0,
		...
		e(b).on("paste",
			function(d) {
				...
				if(null != (null != (a = d.originalEvent) ? a.clipboardData : void 0))
					if(a = d.originalEvent.clipboardData, a.items)
						for(k = a.items, f = 0, g = k.length; f < g; f++) {
							a = k[f];
	...
	return {
		...
		embedSWF: function(a, b, c, d, g, q, h, k, l, n) {
			...
			e.w3 && !(e.wk && 312 > e.wk) && a && b && c && d && g ? (u(b, !1), L(function() {
				...
				if(h && "object" === typeof h)
					for(var s in h) m.flashvars = "undefined" != typeof m.flashvars ? m.flashvars + ("\x26" + s + "\x3d" + h[s]) : s + "\x3d" + h[s];
				if(z(g)) r = J(e, m, b),
					e.id == b && u(b, !0),
					p.success = !0,
					p.ref = r;
		...
		getQueryParamValue: function(a) {
			...
			if(b) {
				/ \ ? /.test(b) &&
					(b = b.split("?")[1]);
				if(null == a) return R(b);
				for(var b = b.split("\x26"), c = 0; c < b.length; c++)
					if(b[c].substring(0, b[c].indexOf("\x3d")) == a) return R(b[c].substring(b[c].indexOf("\x3d") + 1))
			}
			return ""
		},
		expressInstallCallback: function() {
			if(A) {
				...
				a && x && (a.parentNode.replaceChild(x, a), B && (u(B, !0), e.ie && e.win && (x.style.display = "block")), H && H(N));
				A = !1
			}
		}
	}
...
function(e) {
	...
	d.prototype.init = function(b, a, c) {
		...
		for(a = b.length; a--;)
			if(c = b[a], "click" == c) this.$element.on("click." + this.type, this.options.selector, e.proxy(this.toggle, this));
			else if("manual" != c) {
	...
	e.fn.tooltip = function(b) {
		return this.each(function() {
			...
			if(c || !/destroy|hide/.test(b))
				if(c || a.data("bs.tooltip", c = new d(this, f)), "string" == typeof b) c[b]()
		})
	};
...
(function(b) {
	...
	b.extend({
		...
		initGallery: function() {
			...
			b(".gallery").click(function(d) {
				(b(d.target).hasClass("gallery") || b(d.target).hasClass("oper") || b(d.target).hasClass("thumbnails")) && b(".closeWin").click()
			});
...
var DropDownList = function(b, p) {
	...
	l.prototype = {
		...
		show: function() {
			...
			b.each(e,
				function(c, d) {
					if(a.select.val() == b("a", d).attr("data-value")) return f = d, !1
				});
